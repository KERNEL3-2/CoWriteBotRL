...
class PenWorkspaceConfig:
    ...
    # =========================================================================
    # Workspace 분석 결과 기반 (9방향 실패율 분석)
    # 분석일: 2026-01-07
    # Z=0.15~0.25: 실패율 5.7~12.2%
    # Z=0.25~0.30: 실패율 21.6% → 제외
    pen_x_range: Tuple[float, float] = (0.30, 0.50)   # X: 로봇 앞쪽 방향
    pen_y_range: Tuple[float, float] = (-0.15, 0.15)  # Y: 좌우
    pen_z_range: Tuple[float, float] = (0.15, 0.25)   # Z: 높이 (축소)
