...
python3 -m pip install git+https://github.com/leggedrobotics/rsl_rl.git
...
echo "  python3 pen_grasp_rl/scripts/train.py --headless --num_envs 4096"
echo ""
echo "To test policy:"
echo "  python3 pen_grasp_rl/scripts/play.py --checkpoint <path_to_checkpoint>"
