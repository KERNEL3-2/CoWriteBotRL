...
FINE_ALIGN_ROTATION_SPEED = 0.03  # rad/step (V5: 0.02 → 0.03 증가)
DESCEND_SPEED = 0.002             # m/step (V5: 0.003 → 0.002 감소, 더 정밀)
DESCEND_POSE_CORRECTION_GAIN = 1.5  # V5: 자세 보정 강화 (기존 0.5 → 1.5)
